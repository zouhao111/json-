 ...
 * Json格式数据的工具类 
 *  
 * @author xiaofeiqiu, gstausnow@gmail.com 
 * @version 1.0 
 * @since BBF v3.0 
 */  
public class Util {  
...
//            throws Exception {  
//        try {  
//            return Util.getObjectMapper().readValue(resp, classType);  
//        } catch (Exception e) {  
//            throw e;  
//        }  
//    }  
...
//            throws Exception {  
//        try {  
//            ObjectMapper objmap = Util.getObjectMapper();  
//            objmap.disable(DeserializationConfig.Feature.FAIL_ON_UNKNOWN_PROPERTIES);  
//            objmap.configure(SerializationConfig.Feature.FAIL_ON_EMPTY_BEANS,  
//                    false);  
//            objmap.configure(JsonParser.Feature.ALLOW_SINGLE_QUOTES, true);  
//            objmap.configure(JsonParser.Feature.ALLOW_UNQUOTED_CONTROL_CHARS,  
//                    true);  
...
//                    getCollectionType(classObj, valueType));  
//        } catch (Exception e) {  
//            //logger.error("json转换异常", e);  
//            throw e;  
//        }  
